          ...
          <div className="two-col">
            ...
            <div className="reveal">
              <div className="pull-quote">
                ...
                <blockquote>"Without adoption, there was no data. Without data, there was no platform. Without a platform, the entire strategic vision collapsed."</blockquote>
                <cite>The business case for this project</cite>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="insights-grid">
            ...
            <div className="insight-card reveal">
              ...
              <h3 className="insight-title">"The dealer was the broken link nobody was fixing"</h3>
            ...
            <div className="insight-card reveal">
              ...
              <h3 className="insight-title">"The real users were rural millennials, not old farmers"</h3>
